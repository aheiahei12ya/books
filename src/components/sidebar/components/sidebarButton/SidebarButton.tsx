...
export const SidebarButton = forwardRef<unknown, SidebarButtonProps>((props, ref) => {
  ...
  switch (props.type) {
    ...
    case 'tool':
      buttonStyle = props.children ? styles.sidebarToolButton : styles.sidebarToolButtonCenter
